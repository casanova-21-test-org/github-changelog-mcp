...
- **`copilot`**: For reports containing GitHub Copilot changelog entries
- **`actions`**: For reports containing GitHub Actions changelog entries
- **`codespaces`**: For reports containing GitHub Codespaces changelog entries
- **`security`**: For reports containing security-related changelog entries
- **`api`**: For reports containing GitHub API changelog entries
...
- Scan report content to identify relevant product categories
- Apply **all applicable** product labels (reports can contain multiple products)
...
```
"Create a GitHub issue with labels: copilot, actions, security, weekly-report, changelog, automation"
```
